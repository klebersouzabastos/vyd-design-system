...
export const iconNames = ["alert-triangle","angle","bell","check","chevron-down","chevron-left","chevron-right","chevron-up","close","column","cube","dimension","document","download","edit","export","eye","filter","folder","grid","home","info","layers","levels","measure","menu","minus","model","modules","more","plus","search","settings","sheet","slab","structure","user","view-2d","view-3d","wall"];
